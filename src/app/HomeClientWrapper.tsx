...
import { ArrowRight, Star, Flame, ChevronLeft, ChevronRight, SlidersHorizontal } from 'lucide-react';
...
export default function HomeClientWrapper({ products }: HomeClientWrapperProps) {
  ...
  return (
    <div className="w-full space-y-10 sm:space-y-14">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-0 space-y-4">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 z-20">
              ...
              <h3 className="font-syne font-extrabold text-[10px] sm:text-xs uppercase tracking-tight sm:tracking-wider text-white group-hover:text-emerald-400 transition-colors leading-tight break-words">
                Psychology Edition
              </h3>
            </div>
          </Link>
      ...
      {/* 3. NEW DROPS SECTION */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-2 space-y-6">
