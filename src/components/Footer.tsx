      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 pt-14 pb-6 space-y-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs">
              <li><Link href="/contact" className="hover:text-white transition-colors">Our Story</Link></li>
              <li><Link href="/contact" className="hover:text-white transition-colors">Sustainability</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs">
              <li><Link href="/profile#orders" className="hover:text-white transition-colors">Track Order</Link></li>
              <li><Link href="/contact#returns" className="hover:text-white transition-colors">Returns & Exchanges</Link></li>
